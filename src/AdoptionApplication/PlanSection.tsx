      ...
      <div className=" mx-6 h-fit md:pt-12 pb-12 mt-16 flex flex-col items-center justify-center md:flex-row md:mx-12 md:space-x-20 md:h-screen">
        ...
        <div className="mt-16 md:mt-3 md:w-1/2">
          ...
          <p className="text-base">
            ...
            <br />
            <br />
            Once you've found a potential match, our staff will provide you with
            an adoption application form. Complete the form, providing accurate
            information about your living situation, experience with pets, and
            preferences. Our team will then review your application to ensure
            that the pet you've chosen is a good fit for your home and
            lifestyle. We may contact you for additional information or
            clarification if needed.
            <br />
            <br />
            If your application is approved, you'll have the opportunity for a
            meet-and-greet with the pet. Spend time getting to know each other
