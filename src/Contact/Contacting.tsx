    ...
    <section className="flex-col flex mx-4 items-center justify-center mt-20">
      <div className="bg-lightGray w-full mx-auto rounded-lg h-fit mb-6 pb-20 md:w-fit">
        <div className="mx-10 mt-12">
          ...
          <p className="text-sm mx-auto text-center w-80 text-gray font-text leading-6 md:w-1/2">
        ...
        <div className="mx-10 mt-20">
          <div className="flex flex-col items-center space-y-10 mb-14 w-full">
            ...
            />
            <input
              className=" border-lighterGray text-clip input md:w-1/2 rounded-lg  bg-white border px-4 pb-20 pt-4"
              type="text"
