...
export default function HeroSection (props : {mobileHeroClass:string, heroClass: string, heading: string, text: string, text2?: string, btnClass?: string}) {
    return(
        ...
        <div className='mx-1 flex flex-col h-screen justify-center items-base'>
            ...
            <div className='absolute mx-4 md:mx-12 text-white'>
                ...
                <div className={`${props.btnClass} flex flex-col mt-64 md:mt-14 space-y-7`}>
                    <Button
