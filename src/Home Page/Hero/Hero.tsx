  ...
  return (
    <section className="w-full xl:max-w-[2000px] mx-auto">
      <div className="flex flex-col items-center w-full justify-center h-screen">
        <div className="hero-img bg-img absolute md:hidden rounded-lg"></div>
        <div className="hidden md:flex hero-desktop relative rounded-lg"></div>
        ...
        <div className="absolute z-0 flex mx-6 flex-col items-center justify-center lg:mt-10 lg:items-start lg:justify-start top-28">
          <div className="text-center flex flex-col items-center justify-center lg:text-left lg:mt-12 lg:items-start lg:flex-row lg:justify-between lg:mx-20">
            ...
            <p
              ...
              data-aos="fade-up"
              className="text-white text-sm leading-6 w-80 lg:w-96 font-light font-text mt-10 lg:mt-3"
            >
          ...
          <div
            data-aos="fade-up"
            className="button w-full md:w-fit text-center mx-auto text-white lg:mx-20 mt-32 lg:mt-10"
          >
