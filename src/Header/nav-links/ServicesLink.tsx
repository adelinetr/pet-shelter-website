...
export default function ServicesLink() {
    ...
    const toggleLinks = () => {
      if (window.innerWidth < 800) {
        ...
        arrow2.classList.toggle("rotate-90");
  ...
  return (
    <div onClick={toggleLinks} className="group relative overflow-visible ease-in-out">
      <Link
        to="#"
      ...
      <div
        ...
        } relative lg:group-hover:flex lg:text-sm lg:text-center justify-center items-center lg:h-8 text-left mt-6 lg:mt-2 space-y-4 text-lighterGray lg:text-white text-2xl font-light h-40 lg:w-26`}
      >
        <div>
