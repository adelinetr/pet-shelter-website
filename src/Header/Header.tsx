...
export default function Header() {
    return(
        <header className='relative flex flex-col justify-center items-center mt-2'>
        <div className='absolute w-full lg:z-10 mt-32'>
            <div className="mx-10 my-6 flex flex-row items-center justify-between
            md:my-2 lg:mx-16"> 
                <h3 className="text-3xl z-10 font-medium font-logo md:mx-auto text-white md:my-3 lg:items-center">PetShelter</h3>
